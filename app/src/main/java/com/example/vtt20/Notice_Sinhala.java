...
public class Notice_Sinhala extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_notice__sinhala);
        Button btnExitNotice = findViewById(R.id.btn_exit_sin);
        Button btnInsertNotice = findViewById(R.id.btn_send_sin);
        ImageButton btnInputVoice = findViewById(R.id.img_btn_sin);

        NoticePriority = findViewById(R.id.editPrt_sin);
        NoticeToWhom = findViewById(R.id.spin_to_whom_sin);

        loadSpinnerData(); //should fill by group types at the begin

        mVoiceInputTv = findViewById(R.id.editTextNotice_sin);
        //mVoiceInputTv.setEnabled(false);

        NoticeLangType = findViewById(R.id.lang_sinhala);
        NoticeCurrentDate = findViewById(R.id.label_current_date_sin);
        NoticeCurrentTime = findViewById(R.id.label_current_time_sin);
        txtinvisibleUGID = findViewById(R.id.invisibleUserGID);

        NoticeUserLoginName = findViewById(R.id.label_user_login_name_sin);
        NoticeUserTypeLoginName = findViewById(R.id.label_user_type_login_name_sin);
            ...
            public void onClick(View v) {
                try {
                    ...
                    if((ntPrt.equals("Select Priority")) || (ntContent.isEmpty()) || (ntWhom.isEmpty()) || (ntFrom.isEmpty()) || (ntFromUType.isEmpty()) || (ntCurDate.isEmpty()) || (ntCurTime.isEmpty()) || (ntLangType.isEmpty())){
                        ...
                        formatToast.setText("ඕනෑම ක්ෂේත්රයක් හිස් නොවිය යුතුය.");
                        ...
                        if(id<=0)
                        {
                            ...
                            TextView formatToast = layout.findViewById(R.id.txtToast);
                            formatToast.setText("දැන්වීම ඇතුළත් කර නැත.");
                            Toast toast = new Toast(getApplicationContext());
                            toast.setGravity(Gravity.BOTTOM, 0, 100);
                            toast.setDuration(Toast.LENGTH_LONG);
                            toast.setView(layout);
                        ...
                        } else
                        {
                            ...
                            TextView formatToast = layout.findViewById(R.id.txtToast);
                            formatToast.setText("දැනුම්දීම සාර්ථකයි.");
                            Toast toast = new Toast(getApplicationContext());
                            toast.setGravity(Gravity.BOTTOM, 0, 100);
                            toast.setDuration(Toast.LENGTH_LONG);
                            toast.setView(layout);
                            ...
                            ActivityCompat.requestPermissions(Notice_Sinhala.this,new String[]{Manifest.permission.SEND_SMS},1);
        ...
        btnExitNotice.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new AlertDialog.Builder(Notice_Sinhala.this)
                        .setIcon(R.mipmap.main_3)
                        .setTitle("සිංහල දැන්වීම")
                        .setMessage("ඔබට පිටවීමට අවශ්ය බව ඔබට විශ්වාසද?")
                        .setPositiveButton("ඔව්", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                Intent intent=new Intent(Notice_Sinhala.this,MainActivity.class);
                                startActivity(intent);
                            }
                        })
                        .setNegativeButton("නැත",null)
                        .show();
            }
        });
    }
    private void enterNoticeForDBServer() {
        try{
            ...
            Notice_Sinhala.PerformNetworkRequest request = new Notice_Sinhala.PerformNetworkRequest(Api.URL_ENTER_NOTICE, params, CODE_POST_REQUEST);
            request.execute();
        }catch (Exception e){
            LayoutInflater inflater = getLayoutInflater();
            View layout = inflater.inflate(R.layout.toast_warning, (ViewGroup) findViewById(R.id.custom_toast_layout));
...
//        mVoiceInputTv.requestFocus();
//        //InputMethodManager imm = (InputMethodManager) getSystemService(Context.INPUT_METHOD_SERVICE);
//        //imm.showSoftInput(mVoiceInputTv, InputMethodManager.SHOW_IMPLICIT);
//        InputMethodManager inputMethodManager = (InputMethodManager) getSystemService(Context.INPUT_METHOD_SERVICE);
//       // inputMethodManager.toggleSoftInput(InputMethodManager.SHOW_FORCED, 0);
//        inputMethodManager.toggleSoftInput(InputMethodManager.SHOW_IMPLICIT, 0);
//        //inputMethodManager.showSoftInput(mVoiceInputTv, InputMethodManager.SHOW_IMPLICIT);
//    }
//    private void displayKeyboard(){
//        View view=this.getCurrentFocus();
//        if(view!=null){
//            InputMethodManager manager = (InputMethodManager) getSystemService(Context.INPUT_METHOD_SERVICE);
//            manager.showSoftInput((View) view.getWindowToken(),0);
//        }
//    }
...
//            intent.putExtra(RecognizerIntent.EXTRA_PROMPT, "ඔබේ දැන්වීම ඇතුළත් කරන්න.");
